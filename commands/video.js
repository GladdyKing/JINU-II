...
⏳ ɪɴɪᴛɪᴀᴛɪɴɢ ᴠɪᴅᴇᴏ ᴅᴀᴛᴀ ʀᴇᴛʀɪᴇᴠᴀʟ...

💽 ᴊɪɴᴜ-ɪɪ ɪs ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ᴛʜᴇ ɴᴇᴏ-ɴᴇᴛ.

🕶️ “ᴛʜᴇ ꜱʏꜱᴛᴇᴍ ɪꜱ ᴡᴀᴛᴄʜɪɴɢ. ʏᴏᴜʀ ꜰɪʟᴇ ɪꜱ ᴀʟᴍᴏꜱᴛ ʀᴇᴀᴅʏ.”

🌐 ᴘʟᴇᴀsᴇ ʀᴇᴍᴀɪɴ ᴏɴʟɪɴᴇ. ᴅᴀᴛᴀ ꜱᴛʀᴇᴀᴍ ɪɴ ᴘʀᴏɢʀᴇss...

⚡ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊɪɴᴜ-ɪɪ // ᴠɪsᴜᴀʟ-ᴄᴏʀᴇ
`
                }, { quoted: message });
            }
        ...
        await sock.sendMessage(chatId, {
            ...
            caption: `*${videoData.title || videoTitle || 'Video'}*\n\n> *ᴠɪᴅᴇᴏ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ʙʏ ɢʟᴀᴅᴅʏ ᴋɪɴɢ*`
        }, { quoted: message });
