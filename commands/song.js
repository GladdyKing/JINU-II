...
async function songCommand(sock, chatId, message) {
    try {
        ...
        if (!searchQuery) {
            const noQueryMsg = `╭──〔 🎵 ᴊɪɴᴜ-ɪɪ sᴏɴɢ ʀᴇǫᴜᴇsᴛ 🎵 〕──
│
├─ ❌ ɴᴏ sᴏɴɢ ɴᴀᴍᴇ ᴘʀᴏᴠɪᴅᴇᴅ!
├─ 💬 ᴜsᴇ:.song [name or link]
│
╰──〔 ✨ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊɪɴᴜ-ɪɪ 〕──`;
            return await sock.sendMessage(chatId, { text: noQueryMsg}, { quoted: message});
}
        ...
        if (searchQuery.startsWith('http://') || searchQuery.startsWith('https://')) {
            ...
            if (!videos || videos.length === 0) {
                const notFoundMsg = `╭──〔 🔍 ᴊɪɴᴜ-ɪɪ sᴇᴀʀᴄʜ 🎵 〕──
│
├─ ❌ ɴᴏ sᴏɴɢs ғᴏᴜɴᴅ ғᴏʀ: ${searchQuery}
│
╰──〔 ✨ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊɪɴᴜ-ɪɪ 〕──`;
                return await sock.sendMessage(chatId, { text: notFoundMsg}, { quoted: message});
}
        ...
        const styledMessage = `╭──〔 🎉 ᴊɪɴᴜ-ɪɪ sᴏɴɢ ᴅʟ 🎉 〕──
│
├─ 📌 ᴛɪᴛʟᴇ: ${selectedTitle}.mp3
├─ 😎 ᴀᴜᴛʜᴏʀ: ${selectedTitle.split('-')[0].trim()}
├─ ⏱️ ᴅᴜʀᴀᴛɪᴏɴ: ${duration}
├─ 👁️ ᴠɪᴇᴡs: ${views}
├─ 🕒 ᴘᴜʙʟɪsʜᴇᴅ: ${published}
├─ 🔗 ᴜʀʟ: ${videoUrl}
...
╰──〔 ✨ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊɪɴᴜ-ɪɪ 〕──`;
        ...
        const errorMsg = `╭──〔 ⚠️ ᴊɪɴᴜ-ɪɪ ᴇʀʀᴏʀ ⚠️ 〕──
│
├─ ❗ sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ!
├─ 🧠 ᴇʀʀᴏʀ: ${err?.message || 'Unknown error'}
│
╰──〔 ✨ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴊɪɴᴜ-ɪɪ 〕──`;
